...
abstract class AbstractSmtpClient implements SmtpInterface
{
     ...
     *
     * @var \App\Hotash\Contracts\Mail\ImapInterface|\App\Hotash\Mail\AbstractImapClient
     */
    protected $imap;
     ...
     *
     * @param  \App\Hotash\Contracts\Mail\ImapInterface  $client
     * @return static
     */
    ...
    {
        return config('Hotash.mail_client.reply_prefix').trim(
    ...
    {
        return config('Hotash.mail_client.forward_prefix').trim(
            preg_replace($this->cleanupSubjectSearch(), '', $subject)
        );
    }
     ...
     *
     * @param  \App\Hotash\Contracts\Mail\MessageInterface  $message Previous message

...
class Folder extends AbstractFolder
{
    ...
    {
        if ($this->isSelectable() && $imapUidValidity = $this->getEntity()->getStatus(SA_UIDVALIDITY)) {
            // Check if the uidvalidity property is set, as e.q. on Outlook
            // this property may not be present
     ...
     *
     * @return \App\Hotash\Mail\FolderIdentifier
     */

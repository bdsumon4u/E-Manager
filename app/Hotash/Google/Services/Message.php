...
use App\Hotash\Google\Services\Message\Compose;
use App\Hotash\Google\Services\Message\Mail;
...
class Message extends Service
{
    ...
    /**
     * Create new Compose instance.
     *
     * @return \App\Hotash\Google\Services\Message\Compose
     */
    public function compose(): Compose
    {
        return new Compose($this->client);
    }
     ...
     *
     * @param  string  $id
     * @return \App\Hotash\Google\Services\Message\Mail
     */

...
use App\Hotash\Google\Concerns\HasParts;
use App\Hotash\Google\Concerns\HasHeaders;
use App\Hotash\Mail\Headers\HeadersCollection;
use App\Hotash\Google\Concerns\HasDecodeableBody;
...
class Mail
{
     ...
     *
     * @return \App\Hotash\Mail\Headers\AddressHeader
     */
     ...
     *
     * @return \App\Hotash\Google\Services\Message\MailReply
     */
